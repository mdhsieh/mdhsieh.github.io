...
<img src="images/writing/setup_firebase_main.jpg" alt="setup_firebase_main_image" width="800"/>
...
<img src="images/writing/setup_firebase_step_1.png" alt="setup_firebase_step_1" width="800" />

2. You don’t need Analytics for authentication.

<img src="images/writing/setup_firebase_step_2.png" alt="setup_firebase_step_2" width="800" />

3. Select "iOS+" option. Next steps are to add Firebase to your iOS app.

<img src="images/writing/setup_firebase_step_3.png" alt="setup_firebase_step_3" width="800" />
...
<img src="images/writing/bundle_identifier.png" alt="bundle_identifier" width="800" />

5. Download GoogleService-Info.plist.

<img src="images/writing/info_plist.png" alt="info_plist" width="800" />

6. Drag-and-drop to your project name folder and select "Copy items if needed".

<img src="images/writing/copy_info_plist.png" alt="copy_info_plist" width="800" />

7. Use Swift Package Manager to add the firebase-ios-sdk library to your app. In Xcode, use File->Add Packages...

<img src="images/writing/add_firebase_ios_sdk.png" alt="add_firebase_ios_sdk" width="800" />
...
## Next Steps
Now that Firebase is setup, you can choose different services such as [Firebase Authentication](https://firebase.google.com/docs/auth/ios/start) for your app.
